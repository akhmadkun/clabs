...
printf 'LAB-002 baseline data-plane verification\n'
check_ping 192.168.20.1 'Client to R1 LAN'
check_ping 10.0.12.2 'Client through R1 to R2'
check_ping 10.0.13.2 'Client through R1 to R3'
check_ping 10.255.0.1 'Client to R1 loopback'
check_ping 10.255.0.2 'Client to R2 loopback'
check_ping 10.255.0.3 'Client to R3 loopback'
